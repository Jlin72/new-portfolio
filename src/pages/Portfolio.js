            ...
            <div className='card-body'>
              ...
              <p>Click on each image for more information</p>
                <div className='row'>
                  ...
                  <PortfolioImgCard title='Budget tracker' description='A budget tracker web that uses mongoDB to store any information from the user. In addition, the user can add information to the database while offline by using indexedDB.' frontImg={process.env.PUBLIC_URL + '/img/budget-tracker.png'} repoLink='https://github.com/Jlin72/budget-tracker' appLink='https://guarded-cliffs-40752.herokuapp.com/' />
                  <PortfolioImgCard title='Dev-Web' description='An app created for software engineers. In this app developers can get all their tech news and podcasts on just one page.' frontImg={process.env.PUBLIC_URL + '/img/Dev_Web_logo.gif'} repoLink='https://github.com/group04-project03-uoftscs/Dev-Web' appLink='https://dev-web3.herokuapp.com/' />
                </div>
                <div className='row'>
