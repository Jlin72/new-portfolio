            ...
            <div className='card-body'>
              ...
              <p>Click on each image for more information</p>
                <div className='row'>
                  ...
                  <PortfolioImgCard title='Dev-Web' description='An app created for software engineers. In this app developers can get all their tech news and podcasts on just one page.' frontImg={process.env.PUBLIC_URL + '/img/Dev-Web.gif'} repoLink='https://github.com/group04-project03-uoftscs/Dev-Web' appLink='https://dev-web3.herokuapp.com/' />
                </div>
                <div className='row'>
