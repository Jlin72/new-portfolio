            ...
            <div className='card-body'>
              ...
              <p>Click on each image for more information</p>
                <div className='row'>
                  ...
                  <PortfolioImgCard title='Eat da burger' description='An app that tracks the burgers the user have eaten or not. This app uses mySQL to store the user information.' frontImg={process.env.PUBLIC_URL + '/img/burger.png'} repoLink='https://github.com/Jlin72/burger' appLink='https://eatdaburger-jlin.herokuapp.com/' />
                </div>
                <div className='row'>
